...
else reverse(tl(x),hd(x)::z); (*I had learnt this form of reverse and strip function from a youtube video 
https://www.youtube.com/watch?v=JTgYxByRDC4&list=PLbdi8aNvDqlKKXdG7qn0rQsfH0z1hf7FC&index=2 where it was given as an example, 
back when I was learning SML and functional programming, although I did not specifically learn it for this assignment*)
...
fun  isqrtld(x) = 
    let 
        val xList = (explode (x)); 
        fun findSquareRoot(ans,divisor,[],remainder) = (ans,remainder) (*base case of recursion*)
...
Control.Print.printDepth := 2;

val (xx,yy) = isqrtld("1800800000000000914976");
(print(xx); print("\n"));